...
class CanonicalDashboardBuildTests(unittest.TestCase):
    def test_canonical_build_publishes_dashboard_health_insights_shards_and_knowledge(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertIn('href="tools.html"', insights_page)
            self.assertIn(">Tools</a>", insights_page)
            ...
            self.assertIn('href="index.html">Collection</a>', tools_page)
            self.assertIn('href="insights.html">Insights</a>', tools_page)
