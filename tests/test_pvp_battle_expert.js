...
function owned(id, dex, name) {
  return { record_id: id, pokemon_number: dex, name };
}
...
(function testNormalizedFactRequiresExplicitOwnedJoinInputsAndOutcome() {
  ...
  }, { provider: "fixture", model_version: "fixture-1" });
...
(function testMatrixMapsEvidenceToExactOwnedRecordsDeterministically() {
  ...
  const matchups = [
    { attacker_pokemon_number: 1, opponent_id: "x", opponent_name: "X", result: "win", shields: 1, starting_energy: 0, starting_hp_percent: 100 },
    { attacker_pokemon_number: 1, opponent_id: "y", opponent_name: "Y", result: "loss", shields: 1, starting_energy: 0, starting_hp_percent: 100 },
    { attacker_pokemon_number: 2, opponent_id: "y", opponent_name: "Y", result: "win", shields: 1, starting_energy: 0, starting_hp_percent: 100 },
  ];
