...
{
  const result = evaluateTrade("remote", {
  ...
  }, { forever_friend: true, remote_trade_available: true, remote_trades_completed_today: 0, lucky_friend: true }, {}, registry);
...
{
  const result = evaluateTrade("remote", {
    caught_within_30_days: false, previously_traded: false, shadow: true, mythical: false,
    gym_or_power_spot_defender: false, current_buddy: false, active_mega: false, fused: false,
    crowned_zacian_or_zamazenta: false, pokemon_playground: false,
  }, { forever_friend: true, remote_trade_available: true, remote_trades_completed_today: 0 }, {}, registry);
